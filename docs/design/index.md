...
The exact scanner now uses [directory batches and a name arena](/directory-batches.md).
...
- [Directory-batch implementation](/directory-batches.md): current exact scanner and statistical ncdu comparison.
- [Parent-ID implementation](/parent-ids.md): previous checkpoint and paired performance results.
